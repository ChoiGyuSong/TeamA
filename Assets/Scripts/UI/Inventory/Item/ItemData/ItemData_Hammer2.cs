...
[CreateAssetMenu(fileName = "New Item Data - Hammer2", menuName = "Scriptable Object/Item Data - Hammer2", order = 13)]
public class ItemData_Hammer2 : ItemData
{
    [Header("망치2 데이터")]
    ItemData data;

    public override EquipType equipPart => EquipType.Hammer;
