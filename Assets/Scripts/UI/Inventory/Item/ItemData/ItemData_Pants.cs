...
[CreateAssetMenu(fileName = "New Item Data - Pants", menuName = "Scriptable Object/Item Data - Pants", order = 3)]
public class ItemData_Pants : ItemData
{
    [Header("바지 데이터")]
    ItemData data;

    public override EquipType equipPart => EquipType.Pants;
