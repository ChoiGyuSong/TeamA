...
[CreateAssetMenu(fileName = "New Item Data - LBow1", menuName = "Scriptable Object/Item Data - LBow1", order = 6)]
public class ItemData_LBow1 : ItemData
{
    [Header("장궁1 데이터")]
    ItemData data;

    public override EquipType equipPart => EquipType.LBow;
