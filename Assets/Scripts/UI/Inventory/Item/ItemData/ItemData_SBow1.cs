...
[CreateAssetMenu(fileName = "New Item Data - SBow1", menuName = "Scriptable Object/Item Data - SBow1", order = 4)]
public class ItemData_SBow1 : ItemData
{
    [Header("단궁1 데이터")]
    ItemData data;

    public override EquipType equipPart => EquipType.SBow;
