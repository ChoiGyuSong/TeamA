...
[CreateAssetMenu(fileName = "New Item Data - SSword1", menuName = "Scriptable Object/Item Data - SSword1", order = 8)]
public class ItemData_SSword1 : ItemData
{
    [Header("단검1 데이터")]
    ItemData data;

    public override EquipType equipPart => EquipType.SSword;
