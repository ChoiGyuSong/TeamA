...
[CreateAssetMenu(fileName = "New Item Data - LSword1", menuName = "Scriptable Object/Item Data - LSword1", order = 10)]
public class ItemData_LSword1 : ItemData
{
    [Header("대검1 데이터")]
    ItemData data;

    public override EquipType equipPart => EquipType.LSword;
